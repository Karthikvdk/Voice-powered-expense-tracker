        ...
        <CustomizedSnackBar open={open} setOpen={setOpen} />
            <Grid item xs={12}>
                <Typography align="center" variant="subtitle2" gutterBottom>
                    <>
                        {segment && segment.words.map((wParams) => wParams.value).join(" ")}
                    </>
                </Typography>
            </Grid>
            <Grid item xs={6}>
            ...
            <Grid item xs={6}>
                <FormControl fullWidth>
                    ...
                    <Select value={formData.category}
                        ...
                        {selectedCategories.map((categoryParams) =>
                            <MenuItem key={categoryParams.type} value={categoryParams.type}>{categoryParams.type}</MenuItem>)}
                    </Select>
                </FormControl>
            </Grid>
            <Grid item xs={6}>
